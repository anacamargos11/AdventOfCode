...
if __name__ == '__main__':
    ...
    steps = []                        # sum of steps to get to intersections
    ...
    # computing the number of steps required to get to intersection
    [steps.append(path1.index(i) + path2.index(i)) for i in inter]

    result = sorted(steps)[1]
